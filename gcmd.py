...
path1 = '.'
if(path.exists("acom_gcmd.txt")):
    os.remove("acom_gcmd.txt")
fo = open("acom_gcmd.txt", "w+")
...
if(path.exists("acom_gcmd_counts_levels.txt")):
    os.remove("acom_gcmd_counts_levels.txt")

sys.stdout = open("acom_gcmd_counts_levels.txt", "w")
